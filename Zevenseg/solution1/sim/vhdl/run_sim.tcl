...
if {[file isfile Zevenseg.autotvin.dat]} {
	file delete -force Zevenseg.autotvin.dat
}

if {[file isfile Zevenseg.autotvout.dat]} {
	file delete -force Zevenseg.autotvout.dat
}
