...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.Zevenseg.autotvin_sw.dat"
         "c.Zevenseg.autotvout_led_V.dat"
         "c.Zevenseg.autotvout_display_V.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.Zevenseg.autotvout_led_V.dat"
         "rtl.Zevenseg.autotvout_display_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
