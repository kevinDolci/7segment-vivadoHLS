...
$(ObjDir)/Zevenseg_tb.cpp_pre.cpp.tb.o : Zevenseg_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling Zevenseg_tb.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/Zevenseg.cpp_pre.cpp.tb.o : Zevenseg.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling Zevenseg.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
